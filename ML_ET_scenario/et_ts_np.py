...
def create_TS_np(df, features, scores_df, scenario_score):
    ...
    del scores[0]
    print(scores)
    scores = [scenario_score for score in scores]
    print(scores)
...
def get_TS_np(features, time_interval_duration):
    ...
    for filename in FILENAMES_MEDIUM:
        ...
        (temp_TS_np, temp_scores_lst) = create_TS_np(df_medium, features, scores_df_medium, 3)
